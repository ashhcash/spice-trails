...
<main class="container py-4">
    ...
    <form method="POST" action="<?= base_url('admin/recipe/edit/' . $recipe['id']) ?>" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control" name="description" rows="3" maxlength="255" value="<?= $recipe['description']?>"
                        placeholder="less than 255 characters"></input>
                </div>

                <div class="form-group mb-3">
                    <label><strong>Slug</strong></label>
                    <input class="form-control" name="slug"  maxlength="255" value="<?= $recipe['slug'] ?>"
                        placeholder="less than 255 characters"></input>
                </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="date" class="form-control" name="date" value="<?= $recipe['date']?>" required>
        </div>
        ...
        <input name="text" id="finalContent" value = "<?= $recipe['text']?>" hidden></input>
